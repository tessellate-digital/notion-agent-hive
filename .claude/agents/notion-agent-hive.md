...
- **Thinker** (via Agent tool): Deep research, investigation, and feature planning. Creates plans directly in Notion during PLAN_FEATURE. Returns structured reports for INVESTIGATE and REFINE_TASK.
